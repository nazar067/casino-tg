translations = {
    ...
    "searching_online":{
        "en": "🎲 Game is created! Bet: {bet}.\n\n🔎Searching second player.",
        "ru": "🎲 Игра создана! Ставка: {bet}.\n\n🔎Поиск второго игрока.",
        "uk": "🎲 Гру створено! Ставка: {bet}.\n\n🔎Пошук другого гравця.",
    },
    "game_not_found_msg":{
        "en": "⚠️ Game not found or already completed.",
        "ru": "⚠️ Игра не найдена или уже завершена.",
    ...
    "min_bet_exceeds_balance_msg": {
        ...
        "ru": "Минимальная ставка не может превышать ваш текущий баланс.",
        "uk": "Мінімальна ставка не може перевищувати ваш поточний баланс."
    },
    "lowest_min_bet_msg": {
        "en": "The minimum bid must be at least one звезды⭐️",
        "ru": "Минимальная ставка должна быть не меньше одной звезды⭐️",
        "uk": "Мінімальна ставка має бути не меншою за одну звезды⭐️"
    },
    "max_bet_exceeds_balance_msg": {
        "en": "The maximum bet cannot exceed your current balance.",
        "ru": "Максимальная ставка не может превышать ваш текущий баланс.",
        "uk": "Максимальна ставка не може перевищувати ваш поточний баланс."
    },
    "max_bet_less_than_min_bet_msg": {
        "en": "The maximum bet cannot be less than the minimum bet.",
        "ru": "Максимальная ставка не может быть меньше минимальной ставки.",
        "uk": "Максимальна ставка не може бути меншою за мінімальну."
    },
    "invalid_bet_msg": {
        "en": "Invalid input. Please enter a valid number.",
        "ru": "Неверный ввод. Пожалуйста, введите допустимое число.",
        "uk": "Неправильний ввід. Будь ласка, введіть допустиме число."
    },
    "wait_second_player_msg": {
    ...
    "register_no_stars_msg": {
        "en": "You don't have enough stars to create a game with this bet.",
        "ru": "У вас недостаточно звезд для создания игры с этой ставкой.",
        "uk": "У вас недостатньо зірок для створення гри з цією ставкою."
    }
}